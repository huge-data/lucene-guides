...
public class SimpleExampleEn {
	...
	public static void main(String[] args) throws IOException, ParseException {
		...
		// 索引存储的本地文件中
		String filePath = "index/simple_example_en";
		...
		// 待索引文本
		String text1 = "This is a simple example for english text to be indexed.";
		String text2 = "It is a sample for english text to be indexed.";
		...
		// 查询解析
		Query query = parser.parse("text"); // example, sample
